...
Your task is to run Prim'sminimum spanning tree algorithm on this graph.You should 
...
implementation of Prim'salgorithm should work fine.OPTIONAL:For those of you seeking an 
...
G=(V,E)
Initalize X={s} , s belongs to V, s chosen randomly

T= emptySet
While X != V
   Let e:= (u,v) be the cheapest edge of G with u c X , v !c X
